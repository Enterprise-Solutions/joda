...
import {MyDate, MyMonth} from './interfaces.component.ts';

@Component({
    selector: 'my-date-picker',
    directives: [NgIf, NgFor, NgClass, NgStyle],
    templateUrl: 'assets/javascripts/app/datepicker/components/templates/datepicker.template.html'
})
...
export class DatePickerComponent implements OnInit, OnChanges {
    ...
    ngOnChanges(changes: {[propName: string]: SimpleChange}) {
        ...
        if(this.selectionDayTxt !== '' && this.selectionDayTxt !== ' ') {

...
@Component({
    ...
    template: require('./templates/editar-perfiles-usuario.template.html')
})

export class EditarPerfilesUsuarioComponent implements OnInit/*, OnChanges */{
    ...
    public tabs: Array<any> = [
        ...
        {id: 3, title: 'Perfiles',  active: true}
    ];
    ...
    //                 this.mostrarMensaje("Error al editar usuario", false, true);
    //             },
    //             () => {}
    //         );
    // }

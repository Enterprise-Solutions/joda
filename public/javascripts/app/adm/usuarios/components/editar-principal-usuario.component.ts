...
@Component({
    ...
    template: require('./templates/editar-principal-usuario.template.html')
})

export class EditarPrincipalUsuarioComponent implements OnInit/*, OnChanges */{
    ...
    public tabs: Array<any> = [
        {id: 1, title: 'Principal',  active: true},
        {id: 2, title: 'Contraseña',  active: false},
        ...
        this._usuarioService.editarUsuario(this.usuario.id, jsonData)
            .subscribe(
                respuesta => {
                    ...
                    this.notificacion.message = 'Usuario guardado con éxito';
                    setTimeout(() => {
                    }, 5000);
            ...
            this._usuarioService.borrarPerfilUsuario(this.idUsuario, idPerfil)
                .subscribe(
                    response => {
                        ...
                        this.verNotificacion = true;
                        this.notificacion.status =  'success';
                        this.notificacion.message = 'Perfil borrado con éxito';
                        setTimeout(() => {}, 5000);
                    },
                    err =>  {
                        this.verNotificacion = true;
